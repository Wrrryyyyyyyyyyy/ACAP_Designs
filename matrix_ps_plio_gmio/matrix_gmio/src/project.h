...
public:
  input_gmio datain1, datain2;
  //input_port vectorInput, factorInput; 
  //inout_port vectorOutput, factorOutput;
  output_gmio dataout;
  simpleGraph()
  {
    //datain1 = input_plio::create("datain1",plio_32_bits, "data/input_1.txt",500);
    //datain2 = input_plio::create("datain2",plio_32_bits, "data/input_1.txt",500);

    //dataout = output_plio::create("dataout",plio_32_bits, "data/output_1.txt");
   
    datain1 = input_gmio::create("datain1",256, 1000);
    datain2 = input_gmio::create("datain2",256, 1000);
