...
public:
  ...
  simpleGraph()
  {
    datain1 = input_plio::create("datain1",plio_32_bits, "data/inputmatrixa.txt",1250);
    datain2 = input_plio::create("datain2",plio_32_bits, "data/inputmatrix.txt",1250);

    dataout = output_plio::create("dataout",plio_32_bits, "data/output_1.txt",1250);
