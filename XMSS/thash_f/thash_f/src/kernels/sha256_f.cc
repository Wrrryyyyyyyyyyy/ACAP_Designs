...
uint32_t swap32(uint32_t datain){
    uint32_t dataout = 0;
...
void sha256_f(input_stream<uint32> * __restrict prf_in, input_stream<uint32> * __restrict mask_in,  output_stream<uint32>* __restrict dout, output_stream<uint32>* __restrict addr_out)
{
